...
function Sidebar({
  ...
  // Add a new prop to control whether the sidebar pushes content or overlays it
  overlay = false,
  className,
  children,
  ...props
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile}>
        <SheetContent
          ...
          size="content"
          className={cn(
            "p-0 data-[state=open]:border-r-0 data-[state=closed]:border-r-0",
            className
          )}
          {...props}
        >
